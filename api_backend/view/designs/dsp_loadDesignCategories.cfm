<cfoutput query="designCategories">
	<li class="parent_li">
		<span data-list="my" data-level="group" data-item="#cat_id#" data-item="#cat_id#" data-item2="#custom_cat_id#" data-shop="#session.authUser.shop_id#" data-custom="#isCustom#" data-loaded="0"><i class="glyphicon glyphicon-folder-close" style="color:##CCAB26;"></i> #description#</span>
